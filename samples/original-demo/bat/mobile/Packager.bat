...
echo.
echo Android: 
echo - generate a default certificate using 'bat\mobile\CreateCertificate.bat'
echo   or configure a specific certificate in 'bat\mobile\SetupApp.bat'.
echo.
echo iOS: 
echo - configure your developer key and project's Provisioning Profile
echo   in 'bat\mobile\SetupApp.bat'.
echo.
