...
set FLEX_SDK=C:\_sdks\flex4.6_air19
...
:flexsdk
echo.
echo ERROR: incorrect path to Flex SDK in 'bat\mobile\SetupSDK.bat'
echo.
...
:androidsdk
echo.
echo ERROR: incorrect path to Android SDK in 'bat\mobile\SetupSDK.bat'
echo.
