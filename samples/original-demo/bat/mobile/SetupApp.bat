...
:: Android packaging
set AND_CERT_NAME="OpenFLStarlingSamples"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\OpenFLStarlingSamples.p12
...
:: Output packages
set DIST_PATH=dist
set DIST_NAME=OpenFLStarlingSamples
...
echo.
echo ERROR: 
echo   Application ID in 'bat\mobile\SetupApp.bat' (APP_ID) 
