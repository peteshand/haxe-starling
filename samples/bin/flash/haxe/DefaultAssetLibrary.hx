...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/textures/1x/title-logo.png", __ASSET__assets_textures_1x_title_logo_png);
		type.set ("assets/textures/1x/title-logo.png", AssetType.IMAGE);
...
@:keep @:bind #if display private #end class __ASSET__assets_textures_1x_title_logo_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:file("assets/assets/audio/wing_flap.mp3") #if display private #end class __ASSET__assets_audio_wing_flap_mp3 extends lime.utils.ByteArray {}
@:file("assets/assets/fonts/1x/desyrel.fnt") #if display private #end class __ASSET__assets_fonts_1x_desyrel_fnt extends lime.utils.ByteArray {}
@:image("assets/assets/fonts/1x/desyrel.png") #if display private #end class __ASSET__assets_fonts_1x_desyrel_png extends lime.graphics.Image {}
@:file("assets/assets/fonts/2x/desyrel.fnt") #if display private #end class __ASSET__assets_fonts_2x_desyrel_fnt extends lime.utils.ByteArray {}
@:image("assets/assets/fonts/2x/desyrel.png") #if display private #end class __ASSET__assets_fonts_2x_desyrel_png extends lime.graphics.Image {}
@:file("assets/assets/fonts/Ubuntu-License.txt") #if display private #end class __ASSET__assets_fonts_ubuntu_license_txt extends lime.utils.ByteArray {}
@:font("assets/assets/fonts/Ubuntu-R.ttf") #if display private #end class __ASSET__assets_fonts_ubuntu_r_ttf extends lime.text.Font {}
@:image("assets/assets/textures/1x/atlas.png") #if display private #end class __ASSET__assets_textures_1x_atlas_png extends lime.graphics.Image {}
@:file("assets/assets/textures/1x/atlas.xml") #if display private #end class __ASSET__assets_textures_1x_atlas_xml extends lime.utils.ByteArray {}
@:image("assets/assets/textures/1x/background.jpg") #if display private #end class __ASSET__assets_textures_1x_background_jpg extends lime.graphics.Image {}
@:file("assets/assets/textures/1x/compressed_texture.atf") #if display private #end class __ASSET__assets_textures_1x_compressed_texture_atf extends lime.utils.ByteArray {}
@:image("assets/assets/textures/1x/jsHeader.png") #if display private #end class __ASSET__assets_textures_1x_jsheader_png extends lime.graphics.Image {}
@:image("assets/assets/textures/1x/title-logo.png") #if display private #end class __ASSET__assets_textures_1x_title_logo_png extends lime.graphics.Image {}
@:image("assets/assets/textures/2x/atlas.png") #if display private #end class __ASSET__assets_textures_2x_atlas_png extends lime.graphics.Image {}
@:file("assets/assets/textures/2x/atlas.xml") #if display private #end class __ASSET__assets_textures_2x_atlas_xml extends lime.utils.ByteArray {}
@:image("assets/assets/textures/2x/background.jpg") #if display private #end class __ASSET__assets_textures_2x_background_jpg extends lime.graphics.Image {}
@:file("assets/assets/textures/2x/compressed_texture.atf") #if display private #end class __ASSET__assets_textures_2x_compressed_texture_atf extends lime.utils.ByteArray {}
@:image("assets/assets/textures/Untitled.png") #if display private #end class __ASSET__assets_textures_untitled_png extends lime.graphics.Image {}
...
#if openfl
@:keep #if display private #end class __ASSET__OPENFL__assets_fonts_ubuntu_r_ttf extends openfl.text.Font { public function new () { __fontPath = "assets/fonts/Ubuntu-R.ttf"; name = "Ubuntu"; super (); }}
