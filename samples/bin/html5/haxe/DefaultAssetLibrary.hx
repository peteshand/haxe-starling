...
#if openfl
@:keep #if display private #end class __ASSET__OPENFL__assets_fonts_ubuntu_r_ttf extends openfl.text.Font { public function new () { __fontPath = "assets/fonts/Ubuntu-R"; name = "Ubuntu"; super (); }}
